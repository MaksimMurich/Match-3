    ...
    sealed class EcsStartup : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            _systems
                ...
                .Add(new ChargeCellsToDestroySystem())
                .Add(new DestroyCellsSystem())
                .Add(new AddFourInRowBonusCellsSystem())
                ...
                .Add(new AnimateChainExplosionSystem())
                ...
                .OneFrame<ExplosionAnimatedEvent>()
